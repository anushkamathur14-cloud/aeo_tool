...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Dashboard"
        description="How AI answer engines see Peacock this week, across ChatGPT, Claude, Perplexity, Gemini, and Copilot."
      />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tone of AI answers that mention Peacock
            </CardDescription>
          </CardHeader>
          <CardContent>
            <SentimentDonut />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Share of tracked prompts where Peacock appears in the answer
            </CardDescription>
          </CardHeader>
          <CardContent>
            <EngineBarChart />
