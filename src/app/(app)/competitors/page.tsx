...
export default function CompetitorsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Competitors"
        description={`How Peacock stacks up against 5 tracked competitors across the same prompts and engines. Current share-of-voice rank: #${peacockRank} of ${sorted.length}.`}
      />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Weekly visibility score, 12 weeks. Peacock is closing on
              Hulu.
            </CardDescription>
          </CardHeader>
          <CardContent>
